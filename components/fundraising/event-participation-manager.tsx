...
export function EventParticipationManager({ campaign, salesCount, isVolunteering: initialVol, scoutId, logs }: EventProps) {
    ...
    const handleVolunteerToggle = (checked: boolean) => {
        ...
        startTransition(async () => {
            const res = await toggleVolunteer(campaign.id, scoutId, checked)
            if (res.error) {
